        ...
        <div className=" bg-gray-50">
            <div className="w-[90%] md:max-w-7xl mx-auto py-20">
                <div className="space-y-2">
                    <h2 className="text-center font-bold text-3xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-sky-800">Numbers That Set Us Apart</h2>
