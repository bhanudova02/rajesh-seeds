                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
                                <div>
                                    <div className="flex justify-center">
                                        <img src="/icon-units.png" width={1000} height={1000} alt="Counter1" className="w-24 h-24 lg:w-24 lg:h-24 bg-white p-2 rounded-3xl" />
                                    </div>
                                ...
                                <div>
                                    <div className="flex justify-center">
                                        <img src="/icon-workforce.png" width={1000} height={1000} alt="Counter2" className="w-24 h-24 lg:w-24 lg:h-24 bg-white p-2 rounded-3xl" />
                                    </div>
                                ...
                                <div>
                                    <div className="flex justify-center">
                                        <img src="/food-production.png" width={1000} height={1000} alt="Counter3" className="w-24 h-24 lg:w-24 lg:h-24 bg-white p-2 rounded-3xl" />
                                    </div>
                                ...
                                <div>
                                    <div className="flex justify-center">
                                        <img src="/feed-production.png" width={1000} height={1000} alt="Counter3" className="w-24 h-24 lg:w-24 lg:h-24 bg-white p-2 rounded-3xl" />
                                    </div>
                                ...
                                <div>
                                    <div className="flex justify-center">
                                        <img src="/seed-production.png" width={1000} height={1000} alt="Counter3" className="w-24 h-24 lg:w-24 lg:h-24 bg-white p-2 rounded-3xl" />
                                    </div>
