...
export function OurFoodStrengths() {
    const strengths = [
        { icon: <FaTractor />, text: "State-of-the-art processing facility for cut vegetables, frozen fruits and vegetables, and value-added products." },
        { icon: <FaGlobeAmericas />, text: "Export-oriented units: We deliver premium frozen fruits and vegetables to international markets, meeting global quality standards." },
        { icon: <FaShippingFast />, text: "Efficient Logistics: With a focus on timely deliveries, our efficient logistics network guarantees that our produce reaches global markets without compromising quality." },
        { icon: <FaSnowflake />, text: "IQF Facility: Our advanced IQF facility rapidly freezes produce, preserving its freshness and nutrients for optimal quality." },
        { icon: <FaLeaf />, text: "Integrated cold chain facility recognized by the Government of India." },
        { icon: <FaCertificate />, text: "Good Agricultural Practices (GAP) certification." },
        { icon: <FaHandshake />, text: "We stand by our farmers as much as we stand by our clients - from \"Plough to Plate\"." },
        { icon: <FaGlobeAmericas />, text: "We take pride in being a reliable partner for both domestic and international clients." }
    ];
    return (
